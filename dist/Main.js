...
var author$project$Main$api = 'http://localhost:3001/';
...
var author$project$Main$randomQuoteUrl = author$project$Main$api + 'api/random-quote';
...
var author$project$Main$fetchRandomQuote = elm$http$Http$getString(author$project$Main$randomQuoteUrl);
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						elm$html$Html$text('An Elm Quote Retriever')
					])),
				A2(
				elm$html$Html$p,
				_List_fromArray(
					...
					[
						...
						_List_fromArray(
							[
								...
								elm$html$Html$Events$onClick(author$project$Main$GetQuote)
							]),
						_List_fromArray(
							[
